...
//take care of the even and odd parity
// even location minimum colour
// odd location max colour
// remaining location remaining color
...
void solve(){
    ...
    int mNm = V[0].first; char mNmC = V[0].second;
    int SmNm = V[1].first; char SmNmC = V[1].second;
